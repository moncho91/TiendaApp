...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { cantidad: @articulo.cantidad, nombre: @articulo.nombre, precio: @articulo.precio }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { cantidad: @articulo.cantidad, nombre: @articulo.nombre, precio: @articulo.precio }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
